...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    axios__WEBPACK_IMPORTED_MODULE_0___default.a.get('http://127.0.0.1:8000/api/auth/role', {
      headers: {
        Cookie: "cotriadToken=" + self.token
      },
...
var render = function () {
  ...
  return _c("table", { staticClass: "table" }, [
    ...
    _vm._v(" "),
    _vm.info
      ? _c("tbody", [_vm._m(1), _vm._v(" "), _vm._m(2), _vm._v(" "), _vm._m(3)])
      : _vm._e(),
  ])
}
var staticRenderFns = [
