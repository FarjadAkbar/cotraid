...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    permissionByrole: function permissionByrole() {// this.$http.get('/api/auth/getpermission/' + this.roleSelected).then(response => {
      //   this.permissionSelected.push(1);
      //   // this.$emit("option:selected", roleSelected);
