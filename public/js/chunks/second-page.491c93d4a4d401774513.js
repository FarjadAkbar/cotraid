...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      pageLength: 3,
      dir: false,
      codeBasic: !(function webpackMissingModule() { var e = new Error("Cannot find module './code'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()),
      columns: [{
        label: 'Name',
        field: 'fullName'
      }, {
...
var render = function () {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("b-card-code", { attrs: { title: "Basic Table" } }, [
    _c(
      "div",
