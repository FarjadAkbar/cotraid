...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    axios__WEBPACK_IMPORTED_MODULE_5___default.a.get('/api/auth/user').then(function (response) {
      ...
      var ability = new _casl_ability__WEBPACK_IMPORTED_MODULE_16__["PureAbility"]([{
        action: 'read',
        subject: 'Article'
      }, {
        action: 'update',
      ...
      console.log(ability); // console.log(response.data);
      ...
      console.log("error..." + error); // if (error.response.status === 401) {
