  ...
  methods: {
        ...
        return Object(D_xampp_htdocs_coding_vueFIver_starter_kit_node_modules_babel_runtime_helpers_esm_regeneratorRuntime_js__WEBPACK_IMPORTED_MODULE_0__["default"])().wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 5:
                if (_this3.permissionSelected.length) {
                  _context3.next = 9;
                  break;
                }
              ...
              case 9:
                _context3.next = 11;
                return _this3.$http.post('/api/auth/rolepermission/' + _this3.roleSelected, {
                  slug: _this3.permissionSelected
    ...
    permissionByrole: function permissionByrole() {
      ...
      this.$http.get('/api/auth/getpermission/' + this.roleSelected).then(function (response) {
        _this4.permissionSelected = [];

        for (var i in response.data) {
          _this4.permissionSelected.push(response.data[i].slug);
        }
      });
    }
  }
...
var render = function () {
  ...
  return _c(
    "div",
    [
      _vm.can(_vm.user - _vm.permission)
        ? _c(
            "b-button",
            {
              directives: [
