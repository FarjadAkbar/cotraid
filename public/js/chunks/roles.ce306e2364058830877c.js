  ...
  methods: {
    getRoles: function getRoles() {
      ...
      this.$http.get('/api/auth/role').then(function (response) {
        return _this.temp_roles = response.data;
      });

      for (var i in this.temp_roles) {
        this.roles.push({
          label: this.temp_roles[i].name,
          id: this.temp_roles[i].id
        });
      }

      console.log("temp...." + this.temp_roles);
      console.log("main...." + this.roles);
    }
  }
});
