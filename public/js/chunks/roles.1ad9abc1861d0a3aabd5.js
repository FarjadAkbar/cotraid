...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    permissionByrole: function permissionByrole() {
      alert("tes"); // this.$http.get('/api/auth/getpermission/' + this.roleSelected).then(response => {

      this.permissionSelected = [1];
      this.$emit("option:selected", this.permission); //   console.log(response.data)
      // })
    }
  }
});
