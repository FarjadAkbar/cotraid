        ...
        },
        {
          ...
          loaders: {
            ...
            options: {
              ...
              context: '../cotriad-vuejs-bootstrap-vue-template/src/assets/images'
...
/*
 if (mix.inProduction()) {
   ...
   mix.webpackConfig({
     output: {
       publicPath: '/demo/cotriad-vuejs-laravel-admin-template/demo-1/',
       chunkFilename: 'js/chunks/[name].[chunkhash].js'
     }
   })
   mix.setResourceRoot('/demo/cotriad-vuejs-laravel-admin-template/demo-1/')
 }
 */
